...
object Generator {
	...
	private fun processBasic(elements: Array<String>, tagType: String) {
		...
		File("src/main/kotlin/io/persephone/element/$tagType.kt").printWriter().use { out ->
			out.println("package io.persephone.element\n\n")
	...
	private fun process(list: Array<String>, tagType: String) {
		...
		list.forEach { line ->
			...
			File("src/main/kotlin/io/persephone/element/${element.toUpperCase()}.kt").printWriter().use { out ->
				out.println("""package io.persephone.element""")
				out.println("")
