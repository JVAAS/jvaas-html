...
open class BODY(
	...
	var onafterprint: String?
		get() = attributes.get("onafterprint")
		set(value) {
			value?.let {
	...
	var onbeforeunload: String?
		get() = attributes.get("onbeforeunload")
		set(value) {
			value?.let {
	...
	var onhashchange: String?
		get() = attributes.get("onhashchange")
		set(value) {
			value?.let {
